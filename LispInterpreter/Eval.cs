...
namespace LispInterpreter
{
    class Eval
    {
        public static Value eval(Object parseTree, Closure closure)
        {
                        ...
                        case "+":
                            {
                                for (int j = 1; j < ((List<Object>)parseTree).Count(); j++)
                                {
                                    ...
                                    Value val = eval(nextParseTree, closure);
                                    if (val is NumValue)
                                    {
                        ...
                        case "cond":
                            {
                                ...
                                if (list is List<Object>) 
                                {
                                    ...
                                    for (int k = 0; k < ((List<Object>)list).Count(); k++) 
                                    {
                                        ...
                                        BoolValue boolVal = (BoolValue)eval(((List<Object>)deci).ElementAt(0), closure);
                                        if (boolVal.value == true)
                                        {
                                            return eval(((List<Object>)deci).ElementAt(1), closure);
                                        }
                                    }
                                }
                                break;
                        ...
                        case "cons":
                            {
                                if (((List<Object>)parseTree).Count() == 3) 
                                {
                                    ...
                                    Value val_1 = eval(list1, closure);
                                    Value val_2 = eval(list2, closure);
                        ...
                        case "car":
                            {
                                ...
                                {
                                    Object list1 = ((List<Object>)parseTree).ElementAt(1);
                                    PairValue pairVal = (PairValue)eval(list1, closure);
                        ...
                        case "eq?": 
                            {
                                ...
                                SymbolValue val_1_tmp = (SymbolValue)eval(nextParseTree, closure);
                                for (int j = 2; j < ((List<Object>)parseTree).Count(); j++)
                                {
                                    Object nextParseTree_ = ((List<Object>)parseTree).ElementAt(j);
                                    SymbolValue val_2_tmp = (SymbolValue)eval(nextParseTree_, closure);
